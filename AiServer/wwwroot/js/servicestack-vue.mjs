    ...
    return (b, z) => (o(), r("div", {
      ...
      l("div", nc, [
        ...
        c.value && u.value.length ? (o(), r("ul", {
          ...
          (o(!0), r(Fe, null, De(u.value.slice(0, b.maxVisibleItems), (E) => (o(), r("li", {
...
const A0 = { key: 0 }, T0 = { class: "text-red-700" }, F0 = /* @__PURE__ */ l("b", null, "type", -1), I0 = { key: 0 }, D0 = { key: 2 }, j0 = ["innerHTML"], O0 = /* @__PURE__ */ l("input", {
  ...
  setup(e, { emit: t }) {
    ...
    async function te() {
      if (g.value.provider = O.value.name, O.value.name === "authsecret" ? (c.headers.set("authsecret", g.value.authsecret), g.value = i("Authenticate")) : O.value.name === "basic" ? (c.setCredentials(g.value.UserName, g.value.Password), g.value = i("Authenticate"), g.value.UserName = null, g.value.Password = null) : (O.value.name === "jwt" || O.value.type === "Bearer") && (c.bearerToken = g.value.BearerToken, g.value = i("Authenticate")), h.value = await d.api(g.value), h.value.succeeded) {
